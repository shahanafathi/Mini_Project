    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('InitialAmount', models.IntegerField(blank=True, null=True)),
                ('AccountNumber', models.IntegerField(blank=True, null=True)),
                ('Pancardno', models.IntegerField(blank=True, null=True)),
                ('AdharNumber', models.IntegerField(blank=True, null=True)),
